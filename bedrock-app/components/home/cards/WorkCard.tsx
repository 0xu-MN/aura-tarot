...
export const WorkCard: React.FC<WorkCardProps> = ({ onOpenChat, onTokenChange }) => {
  ...
  const { canDraw, recordDraw, grantExtraDraw } = useDrawLimit('work', 2);
...
const s = StyleSheet.create({
  ...
  cardHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, padding: 14, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.06)' },
  ...
  readingBox: { backgroundColor: 'rgba(255,255,255,0.04)', borderRadius: 14, padding: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
  ...
  footer: { padding: 16, paddingBottom: Platform.OS === "ios" ? 24 : 16, borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.06)' },
