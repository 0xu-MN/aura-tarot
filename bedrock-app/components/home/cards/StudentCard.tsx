...
export const StudentCard: React.FC<StudentCardProps> = ({ onOpenChat, onTokenChange, tokenBalance }) => {
  ...
  const { canDraw, recordDraw, isChecking, checkLimit, freeUsage, userTokens } = useDrawLimit('student', 2, 0);
...
const s = StyleSheet.create({
  ...
  cardHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, padding: 12, borderBottomWidth: 1, borderBottomColor: 'rgba(52,211,153,0.18)' },
